...
public class Face2 extends SurfaceView {
    ...
    public Face2(Context context) {
        super(context);
        setWillNotDraw(false);
        randomize();
    }

    public Face2(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        setWillNotDraw(false);
        randomize();
    ...
    public Face2(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    public void onDraw(Canvas canvas){
        ...
        //left eye
        canvas.drawOval(2*canvas.getWidth()/7, canvas.getHeight()/3, 5*canvas.getWidth()/7,2*canvas.getHeight()/3, eyes);
        //right eye
        canvas.drawOval(5*canvas.getWidth()/7, canvas.getHeight()/3, 2*canvas.getWidth()/7,2*canvas.getHeight()/3, eyes);
        //hair
